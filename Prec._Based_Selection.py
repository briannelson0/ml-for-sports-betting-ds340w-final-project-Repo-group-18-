# -*- coding: utf-8 -*-
"""precision_based_selection

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1AHR-pDNAtAH4QtTyFxx56XR8XCT2ko9U
"""

"""
precision_based_selection.py

This script implements a precision-based model selection strategy for
sports betting, designed to sit alongside the existing accuracy-
and calibration-based pipeline in the repository:

    https://github.com/briannelson0/ml-for-sports-betting-ds340w-final-project-Repo-group-18-
...
# ==== CONFIG SECTION – ADJUST THESE TO MATCH YOUR DATASET ====

# Path to your preprocessed dataset (update this to the actual file you use)
DATA_PATH = "data/processed_nba_dataset.csv"

# Column name of the binary outcome you are predicting (1 = home team wins, 0 = otherwise)
TARGET_COL = "home_win"

# Column name of the decimal odds for the outcome you are betting on (e.g., home team win odds)
...
COLUMNS_TO_DROP = ["game_id", "date"]  # edit or empty this list as needed
